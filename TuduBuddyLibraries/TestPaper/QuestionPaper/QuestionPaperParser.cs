...
namespace TestMaterial
{
    public class QuestionPaperParser
    {
        ...
        public QuestionPaperParser(string rawFileData, 
            QuestionPaperFormattingRules rules)
        {
            this.TextData = rawFileData;
        ...
        public List<string> GetQuestionList()
        {
            ...
            if (!string.IsNullOrEmpty(this.TextData))
            {
                questionList = this.TextData.Split(
        ...
        {
            string questionDescriptionWithoutImage = string.Empty;
            ...
            if (!string.IsNullOrEmpty(description))
            {
                ...
                questionDescriptionWithoutImage = description.Remove(startIndex, count);
            }
        ...
        private string GetDifficultyLevel(string questionSection)
        {
            ...
            try
            {
                ...
                if (!CommonUtil.IsEmptyOrWhiteSpace(splitString2[0]))
                {
