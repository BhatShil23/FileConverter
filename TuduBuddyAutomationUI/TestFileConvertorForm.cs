...
namespace TuduBuddyAutomation.UI
{
    public partial class FormTestFileConvertor : Form
    {
        ...
        TestPaperConvertorConfig config = new TestPaperConvertorConfig();
        ...
        {
            string configFile = NamedValue.TestPaperConversion.AppConfigFile;
        ...
        private void LastSavedConfigurationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (StreamReader r = new StreamReader(NamedValue.TestPaperConversion.AppConfigFile))
                {
                    string json = r.ReadToEnd();
                    config = JsonConvert.DeserializeObject<TestPaperConvertorConfig>(json);
                }
        ...
        {
            logger.AppendLog("Saving configuration in file " + NamedValue.TestPaperConversion.AppConfigFile + "...");
            SaveDataToConfig();
